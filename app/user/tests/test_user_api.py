...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        """Tests if creating an user that already exists fails"""
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='test@example.com', password='pass123', name='test')
        payload = {
            'email': 'test@example.com',
            'password': '456213',
            'name': 'test',
    ...
    def test_create_token_without_user(self):
        """Test if token is not created when user doesn't exists"""
        payload = {
            'email': 'test@example.com',
            'password': '456213',
            'name': 'test',
